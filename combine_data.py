...
title_basics = open("./data/title.basics.reduced.tsv", "r", encoding="utf-8")
...
# Repeat process for title ratings data set
title_ratings = open("./data/title.ratings.reduced.tsv", "r", encoding="utf-8")
...
# Finally, we open the name basics data set and begin combining data
...
combined_data.write("nconst\tprimaryName\tbirthYear\tdeathYear\t"
            ...
            for genre in genres:
                for attribute in attributes:
                    for titleType in titleTypes:
                        ...
                        combined_data.write(f"{nconst}\t{primaryName}\t"
